            ...
            <form noValidate autoComplete="off" id="log-form">
              <FormControl className={classes.formControl} fullWidth>
                ...
                >
                  {doctors.map((doctor) => {
                    return (
                      <MenuItem key={doctor._id} value={doctor.lastname}>
                        Dr. {doctor.lastname}
                      </MenuItem>
                    );
                  })}
              ...
              <FormControl className={classes.formControl} fullWidth>
                ...
                />
                <Typography className={classes.formError} component="p">
                  {this.props.logVisitReasonError}
                </Typography>
              </FormControl>
              ...
              <Typography className={classes.formSuccess} component="p">
